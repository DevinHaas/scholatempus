    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex flex-col items-center justify-center p-6">
      ...
      <div className="relative mb-8">
        <div className="absolute inset-0">
          ...
          <div
            className="absolute rounded-full -top-3 -left-3"
            style={{
              width: "200px",
              height: "200px",
              background: isTracking
        ...
        <button
          ...
          className="relative z-10 w-48 h-48 rounded-full text-white text-3xl font-bold transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl"
          style={{
            background: isTracking
